...
namespace FlowCiao.Exceptions
{
    public class FlowCiaoExecutionException : Exception
    {
        ...
        public FlowCiaoExecutionException(string message, [System.Runtime.CompilerServices.CallerFilePath] string handlerName = "", [System.Runtime.CompilerServices.CallerLineNumber] int line = 0)
            : base(message)
        {
            try
            {
