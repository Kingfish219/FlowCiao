IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[FlowCiao].[ProcessExecutionStepDetail]') AND type in (N'U'))
BEGIN

CREATE TABLE [FlowCiao].[ProcessExecutionStepDetail](
